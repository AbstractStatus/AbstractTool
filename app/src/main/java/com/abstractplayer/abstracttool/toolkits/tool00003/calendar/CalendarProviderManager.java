...
/**
 * * Created by 79260 at 2021/8/8 17:50.
 */
...
public class CalendarProviderManager {
    ...
    public static int deleteCalendarAccountByName(Context context) {
        CalendarProviderUtil.checkContextNull(context);
...
//                return builder.append(rRule).append(CalendarProviderUtil.getFinalRRuleMode(endTime)).toString();
//            case RRuleConstant.REPEAT_CYCLE_WEEKLY:
//                return builder.append(rRule).append(CalendarProviderUtil.getWeekForDate(beginTime)).append("; UNTIL = ")
//                        .append(CalendarProviderUtil.getFinalRRuleMode(endTime)).toString();
//            case RRuleConstant.REPEAT_CYCLE_MONTHLY:
//                return builder.append(rRule).append(CalendarProviderUtil.getDayOfMonth(beginTime))
//                        .append("; UNTIL = ").append(CalendarProviderUtil.getFinalRRuleMode(endTime)).toString();
            default:
                return rRule;
        }
    }
    ...
    public static void startCalendarForIntentToInsert(Context context, long beginTime, long endTime,
        ...
        // FIXME: 2019/3/6 VIVO手机无法打开界面，找不到对应的Activity
